...
public class DGTStub extends org.apache.axis.client.Stub implements WSDSTWrapper {
	    ...
	    private static void _initOperationDesc1(){
	        ...
	        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://test", "podSignature"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://test", "WSDemandSignature"), WSDemandSignature.class, false, false);
	        oper.addParameter(param);
	        oper.setReturnType(new javax.xml.namespace.QName("http://test", "WSDemand"));
	        oper.setReturnClass(WSDemand.class);
	        ...
	        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://test", "poIdObj"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://test", "WSDemand"), WSDemand.class, false, false);
	        oper.addParameter(param);
	        oper.setReturnType(new javax.xml.namespace.QName("http://test", "WSDemandSignature"));
	        oper.setReturnClass(WSDemandSignature.class);
	 ...
	 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {podSignature});
	        ...
	        if (_resp instanceof java.rmi.RemoteException) {
	            ...
	            try {
	                return (WSDemand) _resp;
	            } catch (java.lang.Exception _exception) {
	                return (WSDemand) org.apache.axis.utils.JavaUtils.convert(_resp, WSDemand.class);
	            }
	        }
	 ...
	 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {poIdObj});
	        ...
	        if (_resp instanceof java.rmi.RemoteException) {
	            ...
	            extractAttachments(_call);
	            try {
	                return (WSDemandSignature) _resp;
	            } catch (java.lang.Exception _exception) {
	                return (WSDemandSignature) org.apache.axis.utils.JavaUtils.convert(_resp, WSDemandSignature.class);
	            }
	        }
	  } catch (org.apache.axis.AxisFault axisFaultException) {
	  throw axisFaultException;
