/* Generated By:JJTree&JavaCC: Do not edit this line. DFGParserTokenManager.java */
...
public class DFGParserTokenManager implements DFGParserConstants
{
...
private final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 2:
         ...
         return -1;
      case 3:
         if ((active0 & 0xc19000000L) != 0L)
            return 0;
         if ((active0 & 0x1324000000L) != 0L)
         {
            jjmatchedKind = 38;
            jjmatchedPos = 3;
            return 0;
...
private final int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 110:
         return jjMoveStringLiteralDfa1_0(0x408010000L);
      case 111:
...
"\74\75", "\76\75", "\41\75", "\157\162", "\141\156\144", "\156\157\164", "\53", "\55", 
"\52", "\57", "\45", "\141\163\141", "\146\142\171", "\165\160\157\156", 
"\167\166\162", "\146\151\162\163\164", "\156\145\170\164", "\160\162\145\166", 
"\151\163\145\157\144", "\100", "\43", "\144\151\147\162\141\160\150", "\147\162\141\160\150", 
"\156\157\144\145", "\145\144\147\145", "\163\165\142\147\162\141\160\150", "\55\76", null, null, 
null, "\173", "\175", "\133", "\135", "\73", "\42", };
...
public DFGParserTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public DFGParserTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
