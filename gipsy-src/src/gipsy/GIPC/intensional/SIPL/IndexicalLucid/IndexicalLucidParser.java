/* Generated By:JJTree&JavaCC: Do not edit this line. IndexicalLucidParser.java */
 ...
 *
 * $Id: IndexicalLucidParser.java,v 1.24 2005/09/15 03:09:57 mokhov Exp $
 *
 * @author Chun Lei Ren
 ...
 */
public class IndexicalLucidParser/*@bgen(jjtree)*/implements IndexicalLucidParserTreeConstants, IndexicalLucidParserConstants {/*@bgen(jjtree)*/
  protected JJTIndexicalLucidParserState jjtree = new JJTIndexicalLucidParserState();/**
	 * Error count.
	 */
	 ...
	 */
        public AbstractSyntaxTree parse()
        {
                try
                {
                        System.err.println("IndexicalLucid Parser Version $Revision: 1.24 $");
...
// Note: Because of the scope issue, we have to put #ID at this position so that jjtThis can work properly
 ...
 /*@bgen(jjtree) CONST */
  ...
  public IndexicalLucidParserTokenManager token_source;
  ...
  public IndexicalLucidParser(java.io.InputStream stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new IndexicalLucidParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public IndexicalLucidParser(java.io.Reader stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new IndexicalLucidParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  public IndexicalLucidParser(IndexicalLucidParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(IndexicalLucidParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
