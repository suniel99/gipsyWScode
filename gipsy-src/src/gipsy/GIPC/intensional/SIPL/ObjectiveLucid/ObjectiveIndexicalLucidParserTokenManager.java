/* Generated By:JJTree&JavaCC: Do not edit this line. ObjectiveIndexicalLucidParserTokenManager.java */
...
public class ObjectiveIndexicalLucidParserTokenManager implements ObjectiveIndexicalLucidParserConstants
{
        int iCount = 0;
...
public ObjectiveIndexicalLucidParserTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ObjectiveIndexicalLucidParserTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
