/* Generated By:JJTree&JavaCC: Do not edit this line. ObjectiveGIPLParser.java */
 ...
 *
 * $Id: ObjectiveGIPLParser.java,v 1.3 2005/09/15 03:34:29 mokhov Exp $
 *
 * @author Chun Lei Ren
 * @author Serguei Mokhov
 *
 * @see ObjectiveGIPLParserTreeConstants Provides the constants definition for an AST.
 * @see ObjectiveGIPLParserConstants     Provides the constants definition for parser.
 */
public class ObjectiveGIPLParser/*@bgen(jjtree)*/implements ObjectiveGIPLParserTreeConstants, ObjectiveGIPLParserConstants {/*@bgen(jjtree)*/
  protected JJTObjectiveGIPLParserState jjtree = new JJTObjectiveGIPLParserState();/**
	 * Error count.
	 */
	 ...
	 */
        public AbstractSyntaxTree parse()
        {
                try
                {
                        ...
                        System.err.println("ObjectiveGIPL Parser, $Revision: 1.3 $: " + this.iErrorCount + " errors.");
...
/**
 * We start parsing ObjectiveGIPL here.
 */
      ...
      if (jj_2_23(5)) {
        if (jj_2_17(5)) {
          ...
          E1();
                            ...
                            SimpleNode jjtn012 = new SimpleNode(JJTOBJREF);
...
/*
 * Generated by jlucid.sh on Wed Sep 14 23:29:29 EDT 2005
 */

/**
 * @since Wed Sep 14 23:29:29 EDT 2005
 */
 ...
 */
 ...
 /*@bgen(jjtree) URL */
  ...
  public ObjectiveGIPLParserTokenManager token_source;
  ...
  public ObjectiveGIPLParser(java.io.InputStream stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new ObjectiveGIPLParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public ObjectiveGIPLParser(java.io.Reader stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new ObjectiveGIPLParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  public ObjectiveGIPLParser(ObjectiveGIPLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(ObjectiveGIPLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
