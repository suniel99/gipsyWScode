/* Generated By:JJTree&JavaCC: Do not edit this line. ObjectiveGIPLParserTokenManager.java */
...
public class ObjectiveGIPLParserTokenManager implements ObjectiveGIPLParserConstants
{
        int iCount = 0;
...
public ObjectiveGIPLParserTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ObjectiveGIPLParserTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
