/* Generated By:JJTree&JavaCC: Do not edit this line. JGIPLParser.java */
 ...
 *
 * $Id: JGIPLParser.java,v 1.8 2005/09/15 03:34:28 mokhov Exp $
 *
 * @author Chun Lei Ren
 * @author Serguei Mokhov
 *
 * @see JGIPLParserTreeConstants Provides the constants definition for an AST.
 * @see JGIPLParserConstants     Provides the constants definition for parser.
 */
public class JGIPLParser/*@bgen(jjtree)*/implements JGIPLParserTreeConstants, JGIPLParserConstants {/*@bgen(jjtree)*/
  protected JJTJGIPLParserState jjtree = new JJTJGIPLParserState();/**
	 * Error count.
	 */
	 ...
	 */
        public AbstractSyntaxTree parse()
        {
                try
                {
                        ...
                        System.err.println("JGIPL Parser, $Revision: 1.8 $: " + this.iErrorCount + " errors.");
...
/*
 * Generated by jlucid.sh on Wed Sep 14 23:28:45 EDT 2005
 */

/**
 * @since Wed Sep 14 23:28:45 EDT 2005
 */
 ...
 */
 ...
 /*@bgen(jjtree) URL */
  ...
  public JGIPLParserTokenManager token_source;
  ...
  public JGIPLParser(java.io.InputStream stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new JGIPLParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public JGIPLParser(java.io.Reader stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new JGIPLParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  public JGIPLParser(JGIPLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(JGIPLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
